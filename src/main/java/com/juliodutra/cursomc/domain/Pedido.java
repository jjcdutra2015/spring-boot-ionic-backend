package com.juliodutra.cursomc.domain;
...
public class Pedido implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name = "endereco_de_cobranca_id")
	...
	public Pedido(Integer id, Date instante, Cliente cliente, Endereco enderecoDeCobranca) {
		super();
		this.id = id;
