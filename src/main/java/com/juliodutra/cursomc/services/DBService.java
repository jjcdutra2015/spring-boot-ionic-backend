...
import com.juliodutra.cursomc.domain.PagamentoComBoleto;
import com.juliodutra.cursomc.domain.PagamentoComCartao;
import com.juliodutra.cursomc.domain.Pedido;
import com.juliodutra.cursomc.domain.Produto;
import com.juliodutra.cursomc.domain.enums.EstadoPagamento;
...
import com.juliodutra.cursomc.repositories.CidadeRepository;
...
import com.juliodutra.cursomc.repositories.EstadoRepository;
import com.juliodutra.cursomc.repositories.ItemPedidoRepository;
import com.juliodutra.cursomc.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "jjcdutra@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "jjcdutra@yahoo.com.br", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
